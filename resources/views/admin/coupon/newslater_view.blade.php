                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p">Subcribiing Time</th>
                        ...
                        <tbody>
                            @foreach ($subcribers as $key => $subcriber)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($subcriber->created_at)->diffForHumans() }}</td>
                                    <td>
                                        <a href="{{ route('newslater.delete', $subcriber->id) }}"
