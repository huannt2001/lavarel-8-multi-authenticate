    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('sub.category') }}" class="nav-link">Sub
                        Category</a></li>
                <li class="nav-item"><a href="{{ route('all.brand') }}" class="nav-link">Brand</a></li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('all.coupon') }}" class="nav-link">Coupon</a></li>
            </ul>
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item">
                    <a href="{{ route('admin.new.order') }}" class="nav-link">New Order</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('view.accept.payment') }}" class="nav-link">Accept Payment</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('view.cancel.order') }}" class="nav-link">Cancel Order</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('view.process.payment') }}" class="nav-link">Process Delivery</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('view.success.payment') }}" class="nav-link">Delivery Success</a>
                </li>
            </ul>
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('add.blog.categorylist') }}" class="nav-link">Blog
                        Category</a></li>
                <li class="nav-item"><a href="{{ route('add.blogpost') }}" class="nav-link">Add Post</a>
                </li>
                <li class="nav-item"><a href="{{ route('all.blogpost') }}" class="nav-link">Post List</a>
                </li>
            </ul>
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('report.order.today') }}" class="nav-link">Today
                        Order</a>
                </li>
                <li class="nav-item"><a href="{{ route('report.delivery.today') }}"
                        class="nav-link">Today
                        Delivery</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('report.this.month') }}" class="nav-link">
                        This Month
                    </a>
                </li>
                <li class="nav-item">
