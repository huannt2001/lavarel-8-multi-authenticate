                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p">Category name VietNam</th>
                                <th class="wd-20p">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($blogcats as $key => $item)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                    ...
                    <form method="post" action="{{ route('store.blog.category') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Enter Category Name English" name="category_name_en">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Enter Category Name VietNam" name="category_name_vn">
