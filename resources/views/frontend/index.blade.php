...
@section('content')
                                            ...
                                            <div class="deals_content">
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    <div class="deals_item_category">
                                                        <a href="#">{{ $item->brand->brand_name }}</a>
                                                    </div>
                                                ...
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    ...
                                                    @else
                                                        <div class="deals_item_price ml-auto">${{ $item->selling_price }}
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="available">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_content">
                                                        ...
                                                        <div class="product_name">
                                                            <div>
                                                                <a
                                                                    href="{{ url('product/details/' . $item->id . '/' . Str::slug($item->product_name)) }}">{{ $item->product_name }}</a>
                                                            </div>
                                                        </div>
                                ...
                                @foreach ($categories as $item)
                                    ...
                                    <div class="owl-item">
                                        <div
                                            ...
                                            <div class="popular_category_image"><img src="/frontend/images/popular_1.png"
                                                    alt="">
                                            </div>
    ...
    @php
    $midsliders = App\Models\Product::where('status', 1)
        ->where('mid_slider', 1)
        ->orderBy('id', 'DESC')
        ->limit(3)
        ->get();
    ...
    <div class="banner_2">
        ...
        <div class="banner_2_container">
            ...
            <div class="owl-carousel owl-theme banner_2_slider">
                ...
                @if (isset($midsliders) && count($midsliders) > 0)
                    @foreach ($midsliders as $item)
                                        ...
                                        <div class="col-lg-4 col-md-6 fill_height">
                                            <div class="banner_2_content">
                                                ...
                                                <div class="banner_2_text">
                                                    <h4>{{ $item->brand->brand_name }}</h4> <br>
                                        ...
                                        <div class="col-lg-8 col-md-6 fill_height">
                                            <div class="banner_2_image_container">
                                                <div class="banner_2_image"><img src="{{ asset($item->image_one) }}"
                                                        alt="" style="width:400px;height:300px;margin:0 auto">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="banner_2_item">
                            <div class="container fill_height">
                                <div class="row fill_height">
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img src="/frontend/images/banner_2_product.png"
                                                    alt=""></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bestsellers_slider slider">
                                ...
                                <div class="bestsellers_item discount">
                                    <div
                                        ...
                                        <div class="bestsellers_image"><img src="/frontend/images/best_1.png" alt="">
                                        </div>
                                ...
                                <div class="bestsellers_item discount">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="/frontend/images/best_2.png" alt="">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="/frontend/images/best_3.png" alt="">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="/frontend/images/best_4.png" alt="">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item discount">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="/frontend/images/best_5.png" alt="">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="/frontend/images/best_6.png" alt="">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
    ...
    <div class="trends">
        ...
        <div class="container">
            <div class="row">
                ...
                @php
                    $buygets = App\Models\Product::where('status', 1)
                ...
                <div class="col-lg-9">
                    <div class="trends_slider_container">
                        ...
                        <div class="owl-carousel owl-theme trends_slider">
                            @if (isset($buygets) && count($buygets) > 0)
                                @foreach ($buygets as $item)
                                    <!-- Trends Slider Item -->
                                    <div class="owl-item">
                                        <div class="trends_item is_new" style="min-height:417px;">
                                            <div
                                            ...
                                            <div class="trends_content">
                                                ...
                                                <div class="trends_info clearfix">
                                                    <div class="trends_name"><a
                                                            href="product.html">{{ $item->product_name }}</a>
                                                    </div>
                                                    <div class="product_price discount">
                                                        @if ($item->discount_price)
                                                            ${{ $item->discount_price }}<span>${{ $item->selling_price }}</span>
                        ...
                        <div class="owl-carousel owl-theme viewed_slider">
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img src="/frontend/images/view_1.jpg" alt="">
                                    </div>
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img src="/frontend/images/view_2.jpg" alt="">
                                    </div>
                                    <div class="viewed_content text-center">
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img src="/frontend/images/view_3.jpg" alt="">
                                    </div>
                                    <div class="viewed_content text-center">
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img src="/frontend/images/view_4.jpg" alt="">
                                    </div>
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">$379</div>
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img src="/frontend/images/view_5.jpg" alt="">
                                    </div>
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">$225<span>$300</span></div>
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img src="/frontend/images/view_6.jpg" alt="">
                                    </div>
                                    <div class="viewed_content text-center">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLavel">Modal Quick View</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                <li class="list-group-item active">Product Code: <span id="pcode"></span></li>
                                <li class="list-group-item">Category: <span id="pcate"></span></li>
                                <li class="list-group-item">SubCategory: <span id="psubcate"></span></li>
                        ...
                        <div class="col-md-4">
                            <form action="{{ route('insert.into.cart') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="color" class="form-control ml-0" id="color">

                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="size">Size</label>
                                    <select name="size" class="form-control ml-0" id="size">
                                    </select>
                                </div>
                                <div class="form-group">
        ...
        function productView(id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#pcate').text(data.category_name);
                    $('#psubcate').text(data.subcategory_name);
                    $('#pbrand').text(data.brand_name);
                    $('#product_id').val(data.product.id);

                    var da = $('select[name="color"]').empty();
                    $.each(data.color, function(key, value) {
                        $('select[name="color"]').append('<option value="' + value + '">' + value +
                            '</option>')
                    })

                    var da = $('select[name="size"]').empty();
